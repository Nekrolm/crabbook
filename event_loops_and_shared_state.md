...
fn my_routine<State>() -> for<'a> impl Generator< &'a mut Context<State>  > {
    gen {
        ....
    }
}
...
Это оно. Генераторы. Именно такие, какие можно прикрутить к циклу обработки событий с разделяемым состоянием.
